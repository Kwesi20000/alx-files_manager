...
class FilesController {
   ...
   * parameter, returns an error Not found with a status code 404
  ...
  /**
   * this set isPublic to true on the file document based on the ID
   *
   * Retrieves the user based on the token:
   ...
   * returns an error Not found with a status code 404
   * Otherwise:
  ...
  /**
   * this set isPublic to false on the file document based on the ID
   *
   * Retrieves the user based on the token:
   * If not found, returns an error Unauthorized with a status code 401
   * If no file document is linked to the user and the ID passed as parameter,
  ...
  /**
   * this returns the content of the file document based on the ID
   *
   * If no file document is linked to the ID passed as parameter, returns an error
   ...
   * file, returns an error Not found with a status code 404
   * If the type of the file document is folder, returns an error A folder doesn't have content
